      ...
      >
        <div className="max-w-[1800px] mx-auto px-8 flex items-center justify-between">
          ...
          <div className={`hidden md:flex items-center gap-12 text-sm font-medium tracking-widest uppercase transition-colors duration-500 ${textColorClass}`}>
            <a href="#products" onClick={(e) => handleLinkClick(e, 'products')} className="hover:opacity-60 transition-opacity">Suites</a>
            <a href="#" onClick={(e) => handleLinkClick(e, 'catalog')} className="hover:opacity-60 transition-opacity">Dining</a>
            <a href="#about" onClick={(e) => handleLinkClick(e, 'about')} className="hover:opacity-60 transition-opacity">Events</a>
            <a href="#" onClick={(e) => handleLinkClick(e, 'contact')} className="hover:opacity-60 transition-opacity">Contact</a>
          </div>
